...
/**
 * Protobuf message : Mysqlx.Crud.Update
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Crud
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class Update extends \Protobuf\AbstractMessage
{
    ...
    /**
     * operation repeated message = 7
     *
     * @var \Protobuf\Collection<\Mysqlx\Crud\UpdateOperation>
     */
     ...
     * Get 'criteria' value
     *
     * @return \Kambo\Database\Protocolx\Client\Mysqlx\Expr\Expr
     */
     ...
     * Set 'criteria' value
     *
     * @param \Kambo\Database\Protocolx\Client\Mysqlx\Expr\Expr $value
     */
     ...
     * Get 'limit' value
     *
     * @return \Kambo\Database\Protocolx\Client\Mysqlx\Crud\Limit
     */
     ...
     * Set 'limit' value
     *
     * @param \Kambo\Database\Protocolx\Client\Mysqlx\Crud\Limit $value
     */
    public function setLimit(
        \Kambo\Database\Protocolx\Client\Mysqlx\Crud\Limit $value = null
    )
    {
        $this->limit = $value;
    }
     ...
     * @return bool
     */
    public function hasOperationList()
    {
     ...
     * Get 'operation' value
     *
     * @return \Protobuf\Collection<\Mysqlx\Crud\UpdateOperation>
     */
     ...
     * Set 'operation' value
     *
     * @param \Protobuf\Collection<\Mysqlx\Crud\UpdateOperation> $value
     */
    public function setOperationList(\Protobuf\Collection $value = null)
    {
        $this->operation = $value;
    }

    /**
     * Add a new element to 'operation'
     *
     * @param \Mysqlx\Crud\UpdateOperation $value
     */
    public function addOperation(\Kambo\Database\Protocolx\Client\Mysqlx\Crud\UpdateOperation $value)
    {
        if ($this->operation === null) {
            $this->operation = new \Protobuf\MessageCollection();
        }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['operation'] as $item) {
            $message->addOperation($item);
        }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_MESSAGE(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_REPEATED(),
                    'type_name' => '.Mysqlx.Crud.UpdateOperation'
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->collection === null) {
            throw new \UnexpectedValueException('Field "\\Mysqlx\\Crud\\Update#collection" (tag 2) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 7) {
                ...
                $innerSize    = $reader->readVarint($stream);
                $innerMessage = new \Mysqlx\Crud\UpdateOperation();

                if ($this->operation === null) {
                    $this->operation = new \Protobuf\MessageCollection();
                }

                $this->operation->add($innerMessage);
    ...
    {
        if (! $message instanceof \Mysqlx\Crud\Update) {
