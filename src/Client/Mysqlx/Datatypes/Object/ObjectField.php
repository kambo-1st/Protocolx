<?php
namespace Kambo\Database\Protocolx\Client\Mysqlx\Datatypes\Object;

/**
 * Protobuf message : Mysqlx.Datatypes.Object.ObjectField
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Datatypes\Object
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class ObjectField extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setValue(\Mysqlx\Datatypes\Any $value)
    {
        $this->value = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->key === null) {
            throw new \UnexpectedValueException('Field "\\Mysqlx\\Datatypes\\Object\\ObjectField#key" (tag 1) is required but has no value.');
        }

        if ($this->value === null) {
            throw new \UnexpectedValueException('Field "\\Mysqlx\\Datatypes\\Object\\ObjectField#value" (tag 2) is required but has no value.');
        }
    ...
    {
        if (! $message instanceof \Mysqlx\Datatypes\Object\ObjectField) {
