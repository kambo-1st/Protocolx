...
/**
 * Protobuf message : Mysqlx.Expr.Object
 *
...
class Object extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\Mysqlx\Expr\Object\ObjectField>
     */
    protected $fld = null;
     ...
     * Get 'fld' value
     *
     * @return \Protobuf\Collection<\Mysqlx\Expr\Object\ObjectField>
     */
     ...
     * Set 'fld' value
     *
     * @param \Protobuf\Collection<\Mysqlx\Expr\Object\ObjectField> $value
     */
     ...
     *
     * @param \Mysqlx\Expr\Object\ObjectField $value
     */
    public function addFld(\Mysqlx\Expr\Object\ObjectField $value)
    {
        if ($this->fld === null) {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.Mysqlx.Expr.Object.ObjectField'
                ]),
            ],
        ]);
    }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $innerMessage = new \Mysqlx\Expr\Object\ObjectField();
    ...
    {
        if (! $message instanceof \Mysqlx\Expr\Object) {
