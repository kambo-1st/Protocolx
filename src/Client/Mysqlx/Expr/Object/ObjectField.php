<?php
namespace Kambo\Database\Protocolx\Client\Mysqlx\Expr\Object;

/**
 * Protobuf message : Mysqlx.Expr.Object.ObjectField
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Expr\Object
...
class ObjectField extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setValue(\Mysqlx\Expr\Expr $value)
    {
        $this->value = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->key === null) {
            throw new \UnexpectedValueException('Field "\\Mysqlx\\Expr\\Object\\ObjectField#key" (tag 1) is required but has no value.');
        }

        if ($this->value === null) {
            throw new \UnexpectedValueException('Field "\\Mysqlx\\Expr\\Object\\ObjectField#value" (tag 2) is required but has no value.');
        }
    ...
    {
        if (! $message instanceof \Mysqlx\Expr\Object\ObjectField) {
