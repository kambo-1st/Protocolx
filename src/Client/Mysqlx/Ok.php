...
/**
 * Protobuf message : Mysqlx.Ok
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class Ok extends \Protobuf\AbstractMessage
{
     ...
     * @param string $value
     */
    public function setMsg($value = null)
    {
        $this->msg = $value;
    }
    ...
    {
        if (! $message instanceof \Mysqlx\Ok) {
