...
/**
 * Protobuf message : Mysqlx.Resultset.FetchDoneMoreResultsets
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Resultset
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class FetchDoneMoreResultsets extends \Protobuf\AbstractMessage
{
    ...
    {
        if (! $message instanceof \Mysqlx\Resultset\FetchDoneMoreResultsets) {
