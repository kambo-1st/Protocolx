...
/**
 * Protobuf message : Mysqlx.Session.AuthenticateContinue
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Session
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class AuthenticateContinue extends \Protobuf\AbstractMessage
{
    ...
    {
        if (! isset($values['auth_data'])) {
            throw new \InvalidArgumentException(
                'Field "auth_data" (tag 1) is required but has no value.'
            );
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->auth_data === null) {
            throw new \UnexpectedValueException(
                'Field "\\Mysqlx\\Session\\AuthenticateContinue#auth_data"'
    ...
    {
        if (! $message instanceof \Mysqlx\Session\AuthenticateContinue) {
            throw new \InvalidArgumentException(
                sprintf(
