...
/**
 * Protobuf message : Mysqlx.Session.AuthenticateOk
 *
 * @package Kambo\Database\Protocolx\Client\Mysqlx\Session
 * @author  Bohuslav Simek <bohuslav@simek.si>
 * @license MIT
 */
class AuthenticateOk extends \Protobuf\AbstractMessage
{
    ...
    {
        if (! $message instanceof \Mysqlx\Session\AuthenticateOk) {
